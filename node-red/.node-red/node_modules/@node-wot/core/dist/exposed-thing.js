...
var ExposedThing = (function (_super) {
    ...
    ExposedThing.prototype.readProperty = function (propertyName, options) {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.properties[propertyName]) {
                if (_this.properties[propertyName].writeOnly && _this.properties[propertyName].writeOnly === true) {
                    reject(new Error("ExposedThing '" + _this.title + "', property '" + propertyName + "' is writeOnly"));
                }
    ...
    ExposedThing.prototype.writeProperty = function (propertyName, value, options) {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.properties[propertyName]) {
                if (_this.properties[propertyName].readOnly && _this.properties[propertyName].readOnly === true) {
                    reject(new Error("ExposedThing '" + _this.title + "', property '" + propertyName + "' is readOnly"));
                }
